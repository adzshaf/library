...
RSpec.describe Library do
  ...
  context 'put_book' do
    ...
    it 'returns Allocated address: 010101' do
      result = subject.put_book(9_780_747_532_743, 'Harry Potter 1', 'J. K. Rowling')
      expect(result).to eq 'Allocated address: 010101'
    end

    it 'returns Allocated address: 010102 for second book' do
      subject.put_book(9_780_747_532_743, 'Harry Potter 1', 'J. K. Rowling')
      result = subject.put_book(9_780_747_532_744, 'Harry Potter 2', 'J. K. Rowling')
    ...
    it 'should put book to empty space, not replacing book' do
      subject.put_book(9_780_747_532_744, 'Harry Potter', 'J. K. Rowling')
      subject.put_book(9_780_747_532_745, 'Harry Potter 1', 'J. K. Rowling')
      subject.take_book_from('010101')
      subject.put_book(9_780_747_532_744, 'Harry Potter', 'J. K. Rowling')
      subject.put_book(9_780_747_532_746, 'Harry Potter 3', 'J. K. Rowling')
  ...
  context 'take_book_from' do
    ...
    it 'should call book_storage.delete_book_from_position' do
      book = Book.new(9_780_747_532_744, 'Harry Potter', 'J. K. Rowling')
  ...
  context 'find_book' do
    ...
    it "should return Found the book at 010101 if find_book('9780747532744') is called" do
      result = subject.find_book(9_780_747_532_744)
    ...
    it "should return Found the book at 010102 if find_book('9780747532745') is called" do
      result = subject.find_book(9_780_747_532_745)
    ...
    it 'should return Book not found! if find_book of non existent book is called' do
      result = subject.find_book(9_780_747_532_746)
    ...
    it 'should call book_storage.find_book_by_isbn' do
      ...
      expect(subject.book_storage).to receive(:find_book_by_isbn).with(9_780_747_532_746)
      expect(subject.find_book(9_780_747_532_746)).to eq('Book not found!')
    end
  end
  ...
  context 'search_book_by_author' do
    ...
    it 'should return books if books are found from search_book_by_author' do
      ...
      expect(result).to eq("010101: 9780747532744 | Harry Potter | J. K. Rowling\n010102: 9780747532745 | Harry Potter 1 | J. K. Rowling")
    end
  end
