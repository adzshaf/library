...
RSpec.describe PutBookCommand do
    context "execute" do
        ...
        it "should call library#put_book" do
            args = [123456789010, "Harry Potter", "J. K. Rowling"]
            expect_any_instance_of(Library).to receive(:put_book).with(args[0], args[1], args[2]).and_return("Allocated address: 010101")
